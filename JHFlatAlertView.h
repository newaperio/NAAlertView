...
typedef NS_ENUM(NSInteger, JHFlatAlertViewButtonType){
    JHFlatAlertViewButtonTypeRegular = 0,
    JHFlatAlertViewButtonTypeCancel = 1
};

#import <UIKit/UIKit.h>

@interface JHFlatAlertView : UIView
...
/**
 Returns an empty JHFlatAlertView object with just a greyed out background.
 ...
 @return A JHFlatAlertView with just a greyed out background. This method does not draw the alert box.
 */
- (id)init;
...
/**
 Returns a JHFlatAlertView with a title and message.
 
 @param title The title to be displayed by the alert view
 @param message The message to be displayed by the alert view
 @return A JHFlatAlertView that is ready to be displayed with a title and message
 */
- (id)initWithTitle:(NSString *)title message:(NSString *)message;

/**
 Returns a JHFlatAlertView with a title, message, and image.
 
 @param title The title to be displayed by the alert view
 @param message The message to be displayed by the alert view
 @param imagePath The image path of the image to be displayed by the alert view
 @return A JHFlatAlertView that is ready to be displayed with a title, message, and image
 */
...
/**
 ...
 An alert view can only have two buttons. A cancel button and another tpye of button. Adding a button of type other than a `JHFlatAlertViewButtonTypeCancel` will result in the existing button being overwritten.
